...
# 1. 配置路径
work_dir = './work_dirs/shanghai_convlstm/saved'
save_dir = './vis_results_shanghai_convlstm'
...
# 对应 dBZ 范围: 0-76
color_list = [
    (1, 1, 1, 0),  # < 10:   完全透明 (无雨/杂波)
    '#01A0F6',  # 10-20:  深天蓝 (小雨)
    '#00ECEC',  # 20-30:  青色
    '#00D800',  # 30-40:  翠绿 (中雨) - 视觉分界线
    '#019000',  # 40-50:  深绿
    '#FFFF00',  # 50-55:  明黄 (大雨)
    '#E7C000',  # 55-60:  土黄
    '#FF9000',  # 60-65:  橙色
    '#FF0000',  # 65-70:  正红 (暴雨)
    '#D60000',  # 70-75:  深红
    '#C000C0',  # > 75:   紫色/粉白 (极强回波)
]

# 定义分级阈值 (dBZ)
levels = [0, 10, 20, 30, 40, 50, 55, 60, 65, 70, 75]
...
def save_styled_plot(idx):
    ...
    seq_in = inputs[idx].squeeze(1) * scale_factor
    seq_true = trues[idx].squeeze(1) * scale_factor
    seq_pred = preds[idx].squeeze(1) * scale_factor
...
save_styled_plot(78)  # 你可以把 3 改为 max_rain_idx